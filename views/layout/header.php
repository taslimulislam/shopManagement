                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="login-register">
                            ...
                            <li><a  href="<?= VIEW_FRONT."login/create.php"?>" data-effect="mfp-move-from-top"><i class="fa fa-sign-in"></i>Sign in</a>
                            </li>
                            <li><a  href="<?= VIEW_FRONT."customer/create.php"?>" data-effect="mfp-move-from-top"><i class="fa fa-edit"></i>Sign up</a>
                            </li>
